...
abstract class Shape implements IShape {
	...
	/**
	 * Cria um objecto bidimensional que tem uma posição na matriz dada por linha
	 * e coluna
	 * 
	 ...
	 * 
	 * @param numberOfRotations inteiro que representa o número de rotações que a
	 *                          peça pode dar.
	 */
	...
	/**
	 * Metodo que nos retorna um inteiro que representa o elemento da peça que
	 * serve de ancora para a sua colocação na matris de jogo. Caso contário
	 * retorna zero
	 * 
	 * @return um inteiro que representa o elemento na peça que serve de ancora
	 *         para a sua colocação na matriz de jogo.
	 */
...
//			str += "|" + row[i];
	...
	private String printRowText(int rowIndex) {
